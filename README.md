...
## [PPT下载](https://github.com/Huhu-Estelle/API-/blob/master/%E6%99%BA%E8%83%BD%E9%9F%B3%E7%AE%B1%E6%8E%A7%E5%88%B6APP.pptx)
# 若下载不了，请查看Gitee [ppt](https://gitee.com/NFUNM022/API-PPT/blob/master/%E6%99%BA%E8%83%BD%E9%9F%B3%E7%AE%B1%E6%8E%A7%E5%88%B6APP.pptx)
...
解决用户痛点2的AI及概率性考量:
-  2.[百度短语音识别API](https://ai.baidu.com/tech/speech/asr)完成人机交互的部分
 略带口音的普通话、粤语四川话方言、英文，均可有效识别。但对口音浓厚、生僻字有一定障碍。
 融合百度自然语言处理技术，近场中文普通话识别准确率达98% 
-  3.[百度文本情绪识别API](https://ai.baidu.com/tech/nlp_apply/emotion_detection)      
...
| 用户痛点 | API加值 | 重要程度 | 使用场景 
| ------ | ------ | ------ | ------ |
| 想播放自己喜欢的歌曲需要手动选择 | 声纹识别API | 重要 | 用户唤醒音箱，输入口令”小音，放首歌”，APP识别声纹对应到个体，推荐该用户常听的歌曲及类似风格
| 用户很疲惫需要手动选择符合心情的歌曲 | 文本情绪识别API | 重要 | 用户向音箱描述现在的心情，APP识别描述内容后将根据该用户当前的心情推荐歌曲
| 用户需要手动进行一切操作 | 段语音识别API | 较为重要 | 快速识别用户口令，无需手动操作输入
...
- 4.若要添加新用户的声纹，在【我的】界面，根据提示信息朗读显示的数字就可以添加该声纹至语音库。
...
- 声纹识别讯飞（注册500ms,识别900ms）与腾讯云(600ms)响应时间更快。
- 京东万象情绪识别API收取费用较百度更高，阿里情绪识别的费用在使用200次后价格高于百度。
